...
writer_train = SummaryWriter("nii/train")
writer_val = SummaryWriter("nii/val")
wirter_all = SummaryWriter("nii/all")
...
def train_cir():
    ...
    for n in range(len(ls)):
        ...
        torch.save(model.state_dict(),'ckp_xin/CN_lits_transform_model_batch%d.pth'%(n+1))
